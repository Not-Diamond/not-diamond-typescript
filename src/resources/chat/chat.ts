...
import {
  Report,
  ReportRegenerateReportParams,
  ReportRegenerateReportResponse,
...
export interface ChatSelectModelParams {
  llm_providers: Array<ChatSelectModelParams.RequestProvider | ChatSelectModelParams.OpenRouterProvider>;
