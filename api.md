...
- <code><a href="./src/resources/model-router.ts">ModelRouterHealthCheckResponse</a></code>
- <code><a href="./src/resources/model-router.ts">ModelRouterOpenHandsResponse</a></code>
- <code><a href="./src/resources/model-router.ts">ModelRouterSelectModelResponse</a></code>

Methods:

- <code title="get /v2/modelRouter/health">client.modelRouter.<a href="./src/resources/model-router.ts">healthCheck</a>() -> unknown</code>
- <code title="post /v2/modelRouter/openHandsRouter">client.modelRouter.<a href="./src/resources/model-router.ts">openHands</a>({ ...params }) -> unknown</code>
...
- <code><a href="./src/resources/prompt.ts">PromptEstimateAdaptLlmRequestsResponse</a></code>
...
- <code title="post /v2/prompt/estimateAdaptLLMRequests">client.prompt.<a href="./src/resources/prompt.ts">estimateAdaptLlmRequests</a>({ ...params }) -> PromptEstimateAdaptLlmRequestsResponse</code>
...
- <code><a href="./src/resources/chat/report.ts">ReportRegenerateReportResponse</a></code>
- <code><a href="./src/resources/chat/report.ts">ReportReportThumbsResponse</a></code>

Methods:

- <code title="post /v2/chat/report/regenerated">client.chat.report.<a href="./src/resources/chat/report.ts">regenerateReport</a>({ ...params }) -> unknown</code>
...
- <code><a href="./src/resources/llm-usage.ts">LlmUsageRetrieveSummaryResponse</a></code>
...
- <code title="get /v1/llm-usage/summary">client.llmUsage.<a href="./src/resources/llm-usage.ts">retrieveSummary</a>({ ...params }) -> LlmUsageRetrieveSummaryResponse</code>
...
- <code><a href="./src/resources/admin/llm-usage.ts">LlmUsageRetrieveSummaryResponse</a></code>
...
- <code title="get /v1/admin/llm-usage/summary">client.admin.llmUsage.<a href="./src/resources/admin/llm-usage.ts">retrieveSummary</a>({ ...params }) -> LlmUsageRetrieveSummaryResponse</code>
...
- <code><a href="./src/resources/posthog-debug.ts">PosthogDebugRetrieveResponse</a></code>

Methods:

- <code title="get /posthog-debug">client.posthogDebug.<a href="./src/resources/posthog-debug.ts">retrieve</a>() -> unknown</code>
